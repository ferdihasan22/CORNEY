            ...
            {menuOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 w-52 bg-white text-on-surface rounded-xl shadow-xl border border-outline-variant z-50 overflow-hidden">
                  ...
                  <button onClick={() => { setMenuOpen(false); navigate('/ops/kasir/saus') }} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-surface-container text-left"><Icon name="water_drop" className="text-on-surface-variant" /> Saus Habis</button>
