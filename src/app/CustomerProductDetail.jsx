          ...
          <section className="mt-8">
            ...
            <div className="flex flex-col gap-3">
              {branchSauces.map((s) => {
                ...
                return (
                  <button key={s.id} onClick={() => toggleSauce(s)} disabled={disabled} className={`flex items-center justify-between p-4 bg-white rounded-xl shadow-[0_4px_16px_rgba(26,26,26,0.06)] border-2 transition-all text-left ${checked ? 'border-primary' : 'border-surface-container-high'} ${disabled ? 'opacity-40 cursor-not-allowed' : 'active:scale-[.99]'}`}>
